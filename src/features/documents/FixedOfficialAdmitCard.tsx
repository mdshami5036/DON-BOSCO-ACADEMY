    ...
    <div className="fixed-admit-card-root flex justify-center items-center">
      ...
      <div
        ...
        style={{
          ...
          minHeight: '297mm',
          maxHeight: '297mm',
          padding: '10mm 12mm 10mm 12mm', // Safe margins for clean A4 printing
      ...
      >
        ...
        <img
          ...
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.04] pointer-events-none object-contain select-none z-0"
        />

        {/* Outer Double Security Border Container */}
        <div
          className="relative z-10 w-full h-full border-2 border-[#0F2756] rounded-xl p-3 flex flex-col justify-between"
        ...
        >
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between gap-3 border-b-2 border-[#0F2756] pb-2">
              ...
              <div className="text-center flex-1">
                ...
                <p className="text-slate-800 font-semibold text-[8pt] mt-0.5 leading-tight">
                  {schoolAddress}
                </p>
                <p className="text-slate-700 font-medium text-[7.5pt] mt-0.5 leading-tight">
              ...
              <div className="shrink-0 text-right">
                <div className="bg-[#0F2756]/10 border border-[#0F2756]/30 px-2.5 py-1 rounded-md text-center">
                  <span className="block text-[6.5pt] font-black uppercase text-slate-500">ACADEMIC SESSION</span>
                  <strong className="block text-[9pt] font-mono font-black text-[#0F2756]">{data.academic_session}</strong>
                </div>
              </div>
            </div>

            {/* ADMIT CARD Title Bar */}
            <div className="flex items-center justify-between bg-[#0F2756] text-white px-3 py-1 rounded-md mt-1">
              <span className="font-mono text-[7.5pt] tracking-wide font-bold opacity-90">
                ADMIT CARD NO: <strong className="text-amber-300">{data.admit_card_no}</strong>
              </span>
              <h2 className="font-black uppercase tracking-widest text-[10pt] font-display">
          ...
          {/* ========================================================================= */}
          <div className="rounded-lg border border-[#0F2756]/50 bg-slate-50/40 p-2 mt-1">
            <div className="flex items-stretch gap-3">
              {/* Left: 2-Column Key-Value Information Grid */}
              <div className="flex-1 grid grid-cols-2 gap-x-4 gap-y-1 text-[8pt]">
                <div className="flex items-center border-b border-slate-200 pb-0.5">
                  <span className="text-slate-600 font-bold w-[28mm] shrink-0">Candidate Full Name:</span>
                  <strong className="text-slate-950 font-black text-[8.5pt] truncate">{data.student_name}</strong>
                </div>
                <div className="flex items-center border-b border-slate-200 pb-0.5">
                  <span className="text-slate-600 font-bold w-[28mm] shrink-0">Admission / Reg. No.:</span>
                  <strong className="text-[#0F2756] font-mono font-black text-[8.5pt] truncate">
                    {data.admission_no} {data.registration_no ? `(${data.registration_no})` : ''}
                  </strong>
                </div>
                <div className="flex items-center border-b border-slate-200 pb-0.5">
                  <span className="text-slate-600 font-bold w-[28mm] shrink-0">Father's Full Name:</span>
                  <span className="text-slate-900 font-bold truncate">{data.father_name || 'N/A'}</span>
                </div>
                <div className="flex items-center border-b border-slate-200 pb-0.5">
                  <span className="text-slate-600 font-bold w-[28mm] shrink-0">Mother's Full Name:</span>
                  <span className="text-slate-900 font-bold truncate">{data.mother_name || 'N/A'}</span>
                </div>
                <div className="flex items-center border-b border-slate-200 pb-0.5">
                  <span className="text-slate-600 font-bold w-[28mm] shrink-0">Class &amp; Section:</span>
                  <strong className="text-slate-900 font-black text-[8.5pt]">
                    {data.class_name} {data.section_name ? `(Section ${data.section_name})` : ''}
                  </strong>
                </div>
                <div className="flex items-center border-b border-slate-200 pb-0.5">
                  <span className="text-slate-600 font-bold w-[28mm] shrink-0">Roll Number:</span>
                  <strong className="text-[#0F2756] font-mono font-black text-[9pt]">{data.roll_number}</strong>
                </div>
                <div className="flex items-center">
                  <span className="text-slate-600 font-bold w-[28mm] shrink-0">Date of Birth:</span>
                  <span className="text-slate-900 font-mono font-bold">{formatDDMMYYYY(data.dob)}</span>
                </div>
                <div className="flex items-center">
                  <span className="text-slate-600 font-bold w-[28mm] shrink-0">Gender:</span>
              ...
              >
                {data.photo_url ? (
                  ...
                  <div className="text-slate-400 font-black text-[6.5pt] tracking-wider leading-tight">
          ...
          {/* ========================================================================= */}
          <div className="rounded-lg border border-[#0F2756]/50 bg-transparent mt-1 p-2">
            <div className="text-[7.5pt] font-black uppercase text-[#0F2756] tracking-wider border-b border-[#0F2756]/20 pb-1 mb-1 flex items-center justify-between">
            ...
            <div className="grid grid-cols-3 gap-2 text-[7.5pt]">
              <div>
                ...
                <strong className="text-slate-900 font-black text-[8pt] block truncate">{examCenter}</strong>
              </div>
              <div>
              ...
              <div className="flex items-center justify-between gap-1 bg-slate-100/80 px-2 py-0.5 rounded border border-slate-200">
                <div>
                  <span className="text-slate-500 font-bold block text-[6.5pt]">EXAM TIME</span>
                  <strong className="text-[#0F2756] font-mono font-black text-[7.5pt]">{examStartTime}</strong>
                </div>
                <div className="border-l border-slate-300 pl-2">
                  <span className="text-slate-500 font-bold block text-[6.5pt]">REPORTING TIME</span>
                  <strong className="text-rose-900 font-mono font-black text-[7.5pt]">{reportingTime}</strong>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* ========================================================================= */}
          <div className="w-full border-2 border-[#0F2756] rounded-lg overflow-hidden mt-1">
            <div className="bg-[#0F2756] text-white px-3 py-1 flex items-center justify-between">
              <h3 className="font-black uppercase tracking-wider text-[8pt]">
                📅 EXAMINATION SCHEDULE &amp; SUBJECT TIMETABLE
              </h3>
              <span className="text-[7pt] font-medium opacity-90">
                Total Papers: {data.timetable.length} Subjects
              </span>
            </div>

            <table className="w-full border-collapse text-slate-950 text-[7.5pt]">
              <thead>
                <tr className="bg-slate-100 font-black uppercase text-center border-b border-[#0F2756]/30" style={{ height: '6.5mm' }}>
                  <th style={{ width: '10mm', padding: '2px' }} className="border-r border-slate-300">S.No.</th>
                  <th style={{ width: '24mm', padding: '2px' }} className="border-r border-slate-300">Date</th>
                  <th style={{ width: '22mm', padding: '2px' }} className="border-r border-slate-300">Day</th>
                  <th style={{ padding: '2px 8px' }} className="text-left border-r border-slate-300">Subject Name</th>
                  <th style={{ width: '38mm', padding: '2px' }} className="border-r border-slate-300">Exam Time</th>
                  <th style={{ width: '24mm', padding: '2px' }} className="border-r border-slate-300">Reporting</th>
                  <th style={{ width: '26mm', padding: '2px' }}>Invigilator Sign</th>
                </tr>
              </thead>
              <tbody className="bg-transparent divide-y divide-[#0F2756]/20">
                {data.timetable.map((item, idx) => (
                  <tr
                    key={idx}
                    className="text-center hover:bg-slate-50/50"
                    style={{ height: '6mm', lineHeight: '1' }}
                  >
                    ...
                    <td className="text-center">
                      <div className="w-16 h-3.5 border-b border-slate-300 mx-auto"></div>
                    </td>
                  </tr>
                ))}
              </tbody>
          ...
          {/* ========================================================================= */}
          <div className="rounded-lg border border-slate-300 bg-slate-50/70 p-2 mt-1">
            <div className="text-[7pt] font-black uppercase text-[#0F2756] tracking-wider mb-1 flex items-center gap-1.5">
              <span>⚠️ IMPORTANT INSTRUCTIONS FOR CANDIDATES:</span>
            </div>
            <div className="grid grid-cols-2 gap-x-3 gap-y-0.5 text-[6.5pt] text-slate-700 font-medium leading-tight">
          ...
          {/* ========================================================================= */}
          <div className="w-full pt-2 flex items-end justify-between gap-4 px-2 border-t border-slate-200">
            {/* 1. Student / Candidate Signature */}
            <div className="w-[42mm] text-center">
              <div className="h-[9mm] flex items-end justify-center">
                <span className="text-[6.5pt] font-mono text-slate-400 italic">Candidate Sign</span>
              </div>
              <div className="border-t-2 border-slate-700 pt-0.5 text-slate-900 font-bold uppercase text-[7.5pt]">
                Student Signature
              </div>
            </div>
            ...
            <div className="w-[42mm] text-center">
              <div className="h-[9mm] flex items-end justify-center">
                <span className="text-[6.5pt] font-mono text-slate-400 italic">Teacher Verified</span>
              </div>
              <div className="border-t-2 border-slate-700 pt-0.5 text-slate-900 font-bold uppercase text-[7.5pt]">
            ...
            <div className="text-center">
              <div className="bg-transparent inline-block">
                <img
                  ...
                  alt="School Seal"
                  style={{ width: '20mm', height: '20mm', mixBlendMode: 'multiply' }}
                  className="w-[20mm] h-[20mm] mx-auto object-contain opacity-95"
                />
              </div>
            </div>
            ...
            <div className="w-[46mm] text-center">
              ...
              <div className="border-t-2 border-slate-700 pt-0.5 text-slate-900 font-extrabold uppercase text-[7.5pt] leading-none">
                Principal / Headmaster
              </div>
              <div className="text-slate-600 font-semibold text-[6.5pt] mt-0.5">
